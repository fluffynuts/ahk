...
; - I found this on a forum somewhere. It worked well once or twice then failed hard
;   on later usages. Still, it's interesting and I'd probably like to refer back to it
;   at some point, so I'm holding on to it (:
